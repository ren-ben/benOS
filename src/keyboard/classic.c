...
uint8_t classic_keyboad_scancode_to_char(uint8_t scancode) {
...
void classic_keyboard_handle_interrupt() {
    ...
    insb(KEYBOARD_INPUT_PORT); // ignore the second byte
    ...
    uint8_t c = classic_keyboad_scancode_to_char(scancode);
    if (c != 0) {
